...
public class ConversationUtil {
    ...
    public static void main(String[] args) {
        ...
        String file = "Privet privat,- da i\n daa dan      ";
        String newFile = "";
//        Map<String, Integer> map = new HashMap<>();
//        ArrayList<String> arrayWords = new ArrayList<>();
//        int occurrence = 1;
...
//            tempRoot = "";
//            maxOccurrence = 1;
//            for (int j = 0; j < arrayWords.get(i).toCharArray().length - 1; j++) {
//                char[] tempWord = arrayWords.get(i).toCharArray();
//                tempRoot += tempWord[j];
//
//                }
//                if((!map.containsKey(tempRoot) && tempRoot.length() >= 3)) {
//                    occurrence = StringUtils.countMatches(file, tempRoot);
//                    if(occurrence > maxOccurrence) {
//                        maxOccurrence = occurrence;
//                    }
...
//
    ...
    public static String fourdTask(){
          String result = "";
//        String newFile = "";
//        Map<String, Integer> map = new HashMap<>();
//        ArrayList<String> arrayWords = new ArrayList<>();
